...
import com.example.kotlinroomdatabase.databinding.FragmentLoginBindingImpl
import com.example.kotlinroomdatabase.databinding.FragmentWelcomeBinding
...
class WelcomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findNavController().navigate(R.id.action_welcomeFragment_to_quoteActivity)
    }
